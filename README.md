This repository contains my version of the execution of the task of the School 21 SimpleBashUtils.
As a comparison with standard functions, functions on Mac Os Ventura 13.1 were used
The functions were also tested on Ubuntu via Docker for the possibility of building a project.

The School's test system returned 136% out of 140% possible, and managed to detect a memory leak in the pattern search function in the file (flag -f)
I enclose the response of the test system, as well as a checklist for peers.

В данном репозитории содержиться моя версия исполнения задания Школы 21 SimpleBashUtils.
В качестве сравнения со стандартными функциями, использовались функции на Mac Os Ventura 13.1
Так же функции тестировались на Ubuntu через Docker на возможность сборки проекта.

Тестовая система Школы вернула 136% из 140% возможных, причем сумев выявить утечку памяти в функции поиска паттернов в файле(флаг -f)
Прилагаю ответ тестовой системы, а так же чек лист для пиров.
